...
from app.tools import PlotOpenSeesModelTool, DisplayLoadsTool, RunOpenSeesModelTool,GetGeotechnicalInputsForFoundationDesign, PullGeotechnicalReportTool
...
def execute_tool(response: StructuralTools, conversation: list[dict] | None = None) -> tuple[str, go.Figure | None]:
    ...
    #     footing_geometry, cost, soil_pressure, iterations = find_optimal_footing_geometry(response.tool.soil, center_loads)
